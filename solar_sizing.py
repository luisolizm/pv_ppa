...
def build_tor_text(proj_name, proj_date, proj_loc, proj_notes,
    ...
    lines += [
        ...
        "  • Certificación IEC 61215 (ensayos de calificación de diseño y aprobación de tipo)",
        "  • Certificación IEC 61730 (requisitos de seguridad de módulos FV)",
        "  • Cumplimiento UL 61730 para mercado norteamericano (si aplica)",
        "  • Clase de aplicación A (alta tensión de sistema)",
        "  • Resistencia mecánica: carga frontal ≥ 5400 Pa (IEC 61215)",
        "  • Garantía de producto ≥ 12 años; garantía de potencia lineal ≥ 25 años (P90 ≥ 80%)",
        "  • Índice de protección mínimo IP67 (caja de conexiones)",
        "",
        "  INVERSORES:",
        "  • Certificación IEC 62109-1/-2 (Seguridad de convertidores de potencia)",
        "  • Anti-islanding conforme IEEE 1547 / NOM-001-SEDE y requisitos CFE",
        ...
        "  • Diseño estructural conforme ASCE 7 o equivalente (carga de viento, sismo)",
        "  • Resistencia a corrosión: ensayo niebla salina ≥ 1000 h (ISO 9227)",
        "  • Certificación de anclajes por ingeniero estructural acreditado",
        "",
        "  SISTEMA ELÉCTRICO Y PROTECCIONES:",
        "  • Cableado DC: cable solar H1Z2Z2-K o equivalente (IEC 62930)",
        ...
        "  • Sistema de monitoreo con datalogger y acceso remoto (SCADA o plataforma cloud)",
        "  • Resolución de registro ≤ 15 minutos para producción, irradiancia y temperatura",
        "  • Comunicación: Ethernet / Wi-Fi / 4G con protocolo Modbus TCP o SunSpec",
        "  • Variables mínimas a monitorear:",
        "    – Potencia AC y DC por inversor (kW)",
        "    – Energía generada acumulada (kWh)",
        "    – Tensión y corriente por MPPT",
        "    – Temperatura ambiente y de módulo (sonda o sensor integrado)",
        "    – Irradiancia en plano del panel (piranómetro clase 2 mínimo o célula de referencia)",
        "    – Estado de alarmas y eventos (fallo de inversor, aislamiento DC, sobretensión)",
        "  • Disponibilidad de plataforma ≥ 99% (SLA documentado)",
        "  • Exportación de datos en CSV o API REST",
        "",
        "  VERIFICACIONES E INSPECCIONES REQUERIDAS:",
        "  a) Pre-Puesta en Marcha (antes de energizar):",
        "    – Verificación de polaridad y continuidad del cableado DC (IEC 62446-1)",
        "    – Prueba de aislamiento DC ≥ 1 MΩ a 500 V (IEC 61557-2)",
        "    – Inspección visual de montaje, torque y sellado de conectores MC4",
        "    – Verificación de puesta a tierra continuidad (< 1 Ω)",
        "    – Revisión de protecciones AC (interruptores, fusibles, SPDs)",
        "  b) Puesta en Marcha (commissioning):",
        "    – Medición curvas I-V por string (IEC 62446-1) con comparación vs STC",
        "    – Termografía infrarroja de módulos y conexiones bajo carga (IEC TS 62446-3)",
        "    – Verificación de anti-islanding y protecciones de reconexión (IEEE 1547)",
        "    – Prueba de potencia y PR inicial (tolerancia ±3%)",
        "    – Configuración y validación de monitoreo con registro de al menos 48 h",
        "  c) Inspecciones Periódicas (operación):",
        "    – Limpieza de módulos: semestral o según análisis de suciedad",
        "    – Termografía anual de módulos, conexiones e inversores",
        "    – Inspección visual anual de estructura, anclajes y corrosión",
        "    – Prueba de aislamiento DC anual",
        "    – Revisión de firmware de inversores y datalogger (actualizaciones)",
        "    – Análisis de rendimiento vs P90 (PR ≥ 75% objetivo)",
        "",
        "  ENTREGABLES OBLIGATORIOS DEL PROVEEDOR:",
        "  • Simulación en PVSyst / Helioscope (P50 y P90)",
        "  • Planos eléctricos y estructurales firmados por DRO",
        "  • Memoria de cálculo estructural",
        "  • Protocolo de commissioning firmado con resultados de pruebas I-V, termografía y PR",
        "  • Informe de inspección pre-puesta en marcha (checklist IEC 62446-1)",
        "  • Trámite de interconexión CFE (Contrato de Interconexión en Pequeña Escala o GD)",
        "  • Permiso CRE si aplica (> 0.5 MW)",
        "  • Manual de O&M con plan de inspecciones periódicas",
        "  • Garantías de equipos y de ejecución (mínimo 1 año post-puesta en marcha)",
        "",
...
def build_pdf_sizing(
    ...
    specs = [
        ...
        ("Clase aplicación",   "Clase A · Tensión sistema ≥ 1000 V DC"),
        ("Carga mecánica",     "Frontal ≥ 5400 Pa (IEC 61215) · IP67 mínimo en caja de conexiones"),
        ...
        ("Variables monitor.",  "Potencia AC/DC, energía acumulada, tensión/corriente por MPPT, temperatura módulo, irradiancia (piranómetro clase 2), alarmas"),
    ]
    ...
    entregables = [
        "Simulación detallada en PVSyst / Helioscope (P50 y P90)",
        ...
        "Trámite de interconexión CFE (Contrato Pequeña Escala o GD) · Permiso CRE si > 0.5 MW",
        "Garantías de equipos y ejecución (mínimo 1 año post-puesta en marcha)",
        "Protocolo de commissioning: curvas I-V, termografía IR, aislamiento DC",
    ]
...
tab1, tab3 = st.tabs(["⚡  Turnkey Solar", "📄  PPA · Venta al Cliente"])
...
""", unsafe_allow_html=True)
    ...
    with col_r:
        ...
        co2_saved   = annual_gen * 0.454   # kg/año  (factor 0.454 kg/kWh red MX)
  ...
  <div style="border-top:1px solid #1e2230;margin-top:10px;padding-top:10px;">
    ...
    <div class="pc-grid">
      ...
      <div class="pc-item">
        ...
        <span class="pc-val" style="font-size:11px;color:#64748b;font-family:Inter,sans-serif;">0.454 kg CO₂/kWh · Red eléctrica MX (SENER)</span>
      </div>
    </div>
  </div>
</div>
