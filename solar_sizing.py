...
# Fuente: SENER / CENACE — Factor de Emisión del SEN 2022: 0.4486 kg CO₂/kWh
# (redondeado a 0.449; actualizar anualmente con el reporte SENER más reciente).
CO2_FACTOR_KG_KWH = 0.449   # kg CO₂/kWh
...
def build_tor_text(proj_name, proj_date, proj_loc, proj_notes,
    ...
    lines = [
        ...
        f"  CO₂ evitado/año      : {co2_saved/1000:,.2f} t  (factor {CO2_FACTOR_KG_KWH} kg/kWh · SEN SENER/CENACE 2022)",
        "",
...
def build_pdf_sizing(
    ...
    story.append(_kpi_table([
        ...
        ("CO&#8322; evitado", f"{co2_saved/1000:,.2f} t/a",f"Factor {CO2_FACTOR_KG_KWH} kg/kWh SEN"),
    ], S))
    ...
    notas = [
        ...
        f"Factor de emisión CO₂ de referencia: {CO2_FACTOR_KG_KWH} kg CO₂/kWh (SEN — SENER/CENACE 2022). Actualizar con el reporte anual más reciente.",
    ]
    for n in notas:
...
<div class="tor-hero">
  ...
  <div class="th-grid">
    ...
    <div class="th-item">
      ...
      <span class="th-val">{"—" if not uso_area else f"{area_used:,.1f}"}</span>
  ...
  <div style="border-top:1px solid #1e2230;margin-top:10px;padding-top:10px;">
    ...
    <div class="pc-grid">
      ...
      <div class="pc-item">
        ...
        <span class="pc-val" style="font-size:11px;color:#64748b;font-family:Inter,sans-serif;">{CO2_FACTOR_KG_KWH} kg CO₂/kWh · SEN SENER/CENACE 2022</span>
      </div>
    </div>
  </div>
</div>
