...
def build_tor_text(proj_name, proj_date, proj_loc, proj_notes,
    ...
    lines = [
        ...
        f"  Carga estructural    : {n_panels * panel_peso_kg * 1.35:,.0f} kg  ({n_panels * panel_peso_kg * 1.35 * 9.81 / 1000:.2f} kN)  ({n_panels * panel_peso_kg * 1.35 * 9.81 / 1000 / max(n_panels * panel_area, 0.01):.3f} kN/m² sobre área instalada)  [factor ×1.35 montura+BOS]",
        "",
    ...
    panel_rows = [
        ...
        [Paragraph("Carga total (x1.35)", S["td_l"]),
         Paragraph(f"{n_panels * panel_peso_kg * 1.35:,.0f} kg  |  "
                   f"{n_panels * panel_peso_kg * 1.35 * 9.81 / 1000:.2f} kN", S["td"])],
        [Paragraph("Carga por m² instalado", S["td_l"]),
         Paragraph(f"{n_panels * panel_peso_kg * 1.35 * 9.81 / 1000 / max(n_panels * panel_area, 0.01):.3f} kN/m²  "
  ...
  <div style="border-top:1px solid #2a2d3a;margin-top:10px;padding-top:10px;">
    ...
    <div class="pc-grid">
      ...
      <div class="pc-item">
        ...
        <span class="pc-val" style="color:#f87171;">{n_panels * panel_peso_kg * 1.35 * 9.81 / 1000:.2f} kN</span>
      </div>
      <div class="pc-item">
        <span class="pc-label">Carga por m² instalado</span>
        <span class="pc-val" style="color:#f87171;">{n_panels * panel_peso_kg * 1.35 * 9.81 / 1000 / max(n_panels * panel_area, 0.01):.3f} kN/m²</span>
      </div>
      <div class="pc-item">
